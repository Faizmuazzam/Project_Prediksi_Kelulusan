...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tb_data_prediksi List</h2>
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('data_prediksi/index'); ?>" class="form-inline" method="get">
		...
		<?php echo anchor(site_url('data_prediksi/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
