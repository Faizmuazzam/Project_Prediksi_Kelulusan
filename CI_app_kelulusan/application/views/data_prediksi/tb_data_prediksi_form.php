...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tb_data_prediksi <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="varchar">Result <?php echo form_error('result') ?></label>
            <input type="text" class="form-control" name="result" id="result" placeholder="Result" value="<?php echo $result; ?>" />
        </div>
	    <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('data_prediksi') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>