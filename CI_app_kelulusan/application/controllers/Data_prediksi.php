...
class Data_prediksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('data_prediksi/tb_data_prediksi_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'result' => $row->result,
            ...
            $this->load->view('data_prediksi/tb_data_prediksi_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('data_prediksi/tb_data_prediksi_form', $data);
    }
